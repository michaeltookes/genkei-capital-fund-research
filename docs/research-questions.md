...
- **outcome:** (fills in when the 07-26 decision resolves — record both the decision's SOL-benchmark alpha AND the override's realized result so the reflection cycle scores the *disagreement*, not just the call)
