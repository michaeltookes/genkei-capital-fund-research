...
### B-015 — Define initial watchlists
- **Status:** open
- **Priority:** high
- **Context:** Most ingesters need a watchlist to drive what to pull. ~25 equities, 10–20 crypto, 10 DeFi protocols, 20 macro series.
- **Acceptance criteria:**
  - `config/watchlists.yml` (or split across files) populated with initial picks.
