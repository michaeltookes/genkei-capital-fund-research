...
The April 2026 small net disposal (-48k shares across 5 transactions) is **not a cluster** by the engine's threshold (≥3 reporters within 7 days). Looks like ordinary scheduled selling, not directional conviction.
