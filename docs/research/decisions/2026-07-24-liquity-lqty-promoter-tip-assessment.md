...
**Web sweep (CoinGecko + DefiLlama API, fetched 2026-07-24 — LQTY is not a watchlist asset, so token-level figures are external; supply figures cross-check the lake within rounding):**
