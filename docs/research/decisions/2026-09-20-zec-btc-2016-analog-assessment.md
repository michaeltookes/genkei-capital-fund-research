...
1. **Base (~50%):** the run tops out in the $1,600–3,500 band, including completion of the $3,192 launch-anomaly ATH, then gives back 50%+ from peak within the window.
