...
2. **Failure / thesis break (~5%):** a close below the ~$484 August base before or at grade date. If the failure follows a higher price-threshold hit, record the highest threshold tier separately from the terminal failure state; if no higher threshold was reached, this is the ladder's failure probability bucket.
